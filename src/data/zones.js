...
export const zones = [
  ...
  // — technology —
  {
    ...
    status: 'confirmed',
    category: 'technology',
    hypercastle: [{ level: 17 }, { level: 18 }, { level: 19 }, { level: 20 }],
  ...
  // — music —
  {
    ...
    status: 'confirmed',
    category: 'music',
    hypercastle: [{ level: 13, elevation: 1 }],
  ...
  },
  {
    ...
    status: 'confirmed',
    category: 'music',
    hypercastle: [{ level: 11, elevation: -2 }],
  ...
  // — card game —
  {
    ...
    status: 'confirmed',
    category: 'cardGame',
    hypercastle: [{ level: 16, elevation: 4 }, { level: 16, elevation: -3 }],
  ...
  },
  {
    ...
    status: 'confirmed',
    category: 'cardGame',
    hypercastle: [{ level: 15, elevation: -2 }],
  ...
  },
  {
    ...
    status: 'confirmed',
    category: 'cardGame',
    hypercastle: [{ level: 8, elevation: 3 }, { level: 8, elevation: -3 }],
  ...
  },
  {
    ...
    status: 'confirmed',
    category: 'cardGame',
    hypercastle: [{ level: 16, elevation: -2 }],
  ...
  // — crypto art —
  {
    ...
    status: 'confirmed',
    category: 'cryptoArt',
    hypercastle: [{ level: 13, elevation: 2 }],
  ...
  },
  {
    ...
    status: 'confirmed',
    category: 'cryptoArt',
    hypercastle: [{ level: 9, elevation: 2 }, { level: 9, elevation: -1 }, { level: 9, elevation: -4 }],
  ...
  },
  {
    ...
    status: 'confirmed',
    category: 'cryptoArt',
    hypercastle: [{ level: 14, elevation: -2 }],
  ...
  },
  {
    ...
    status: 'confirmed',
    category: 'cryptoArt',
    hypercastle: [{ level: 15, elevation: -1 }],
  ...
  // — nature —
  {
    ...
    status: 'confirmed',
    category: 'nature',
    hypercastle: [{ level: 8, elevation: 2 }, { level: 8, elevation: -4 }],
  ...
  },
  {
    ...
    status: 'confirmed',
    category: 'nature',
    hypercastle: [{ level: 7, elevation: 0 }],
  ...
  // — video game —
  {
    ...
    status: 'confirmed',
    category: 'videoGame',
    hypercastle: [{ level: 11, elevation: 3 }, { level: 11, elevation: -4 }],
  ...
  },
  {
    ...
    status: 'confirmed',
    category: 'videoGame',
    hypercastle: [{ level: 8, elevation: 4 }, { level: 8, elevation: -2 }],
  ...
  },
  {
    ...
    status: 'confirmed',
    category: 'videoGame',
    hypercastle: [{ level: 12, elevation: 4 }, { level: 12, elevation: 2 }, { level: 12, elevation: 0 }, { level: 12, elevation: -2 }, { level: 12, elevation: -4 }],
  ...
  },
  {
    ...
    status: 'confirmed',
    category: 'videoGame',
    hypercastle: [{ level: 13, elevation: -4 }],
  ...
  },
  {
    ...
    status: 'confirmed',
    category: 'animeFilm',
    hypercastle: [{ level: 5, elevation: 3 }, { level: 5, elevation: 0 }, { level: 5, elevation: -3 }],
  ...
  },
  {
    ...
    status: 'confirmed',
    category: 'animeFilm',
    hypercastle: [{ level: 16, elevation: -1 }],
    twin: true,
  ...
  },
  {
    ...
    status: 'confirmed',
    category: 'animeFilm',
    hypercastle: [{ level: 15, elevation: -4 }],
    twin: true,
  ...
  // — architecture —
  {
    ...
    hypercastle: [{ level: 10, elevation: 1 }],
  ...
  // — print media —
  {
    ...
    status: 'confirmed',
    category: 'printMedia',
    hypercastle: [{ level: 14, elevation: 0 }],
  ...
  // — technology —
  {
    ...
    status: 'uncertain',
    category: 'technology',
    hypercastle: [{ level: 12, elevation: 3 }, { level: 12, elevation: 1 }, { level: 12, elevation: -1 }, { level: 12, elevation: -3 }],
  ...
  // — music —
  {
    ...
    status: 'uncertain',
    category: 'music',
    hypercastle: [{ level: 14, elevation: -3 }],
  ...
  // — card game —
  {
    ...
    status: 'uncertain',
    category: 'cardGame',
    hypercastle: [{ level: 14, elevation: 4 }, { level: 14, elevation: -4 }],
  ...
  // — video game —
  {
    ...
    status: 'uncertain',
    category: 'videoGame',
    hypercastle: [{ level: 9, elevation: 4 }, { level: 9, elevation: 1 }, { level: 9, elevation: -2 }],
  ...
  },
  {
    ...
    status: 'uncertain',
    category: 'videoGame',
    hypercastle: [{ level: 10, elevation: 0 }],
  ...
  },
  {
    ...
    status: 'uncertain',
    category: 'videoGame',
    hypercastle: [{ level: 1 }, { level: 2 }, { level: 3 }, { level: 4 }],
  ...
  },
  {
    ...
    status: 'uncertain',
    category: 'videoGame',
    hypercastle: [{ level: 13, elevation: 0 }],
  ...
  },
  {
    ...
    status: 'uncertain',
    category: 'videoGame',
    hypercastle: [{ level: 6, elevation: 3 }, { level: 6, elevation: -3 }],
  ...
  },
  {
    ...
    status: 'uncertain',
    category: 'videoGame',
    hypercastle: [{ level: 10, elevation: 2 }],
  ...
  // — anime / film —
  {
    ...
    status: 'uncertain',
    category: 'animeFilm',
    hypercastle: [{ level: 15, elevation: -3 }],
  ...
  },
  {
    ...
    status: 'uncertain',
    category: 'animeFilm',
    hypercastle: [{ level: 9, elevation: 3 }, { level: 9, elevation: 0 }, { level: 9, elevation: -3 }],
  ...
  },
  {
    ...
    status: 'uncertain',
    category: 'uncertain',
    hypercastle: [{ level: 13, elevation: 3 }],
  ...
  },
  {
    ...
    status: 'uncertain',
    category: null,
    hypercastle: [{ level: 6, elevation: 0 }],
  ...
  },
  {
    ...
    status: 'uncertain',
    category: null,
    hypercastle: [{ level: 6, elevation: 1 }],
  ...
  },
  {
    ...
    status: 'uncertain',
    category: null,
    hypercastle: [{ level: 7, elevation: 1 }, { level: 7, elevation: -4 }],
  ...
  },
  {
    ...
    status: 'uncertain',
    category: null,
    hypercastle: [{ level: 10, elevation: -3 }],
  ...
  },
  {
    ...
    status: 'uncertain',
    category: null,
    hypercastle: [{ level: 6, elevation: 4 }, { level: 6, elevation: -2 }],
...

  {
    ...
    category: null,
    twin: true,
    hypercastle: [{ level: 8, elevation: 1 }],
  ...
  },
  {
    ...
    category: 'twinPalette',
    twin: true,
    hypercastle: [{ level: 16, elevation: 0 }],
  ...
  },
  {
    ...
    category: 'twinPalette',
    twin: true,
    hypercastle: [{ level: 10, elevation: 4 }, { level: 10, elevation: -4 }],
...

  {
    ...
    status: 'llm',
    category: 'cryptoArt',
    hypercastle: [{ level: 7, elevation: 3 }, { level: 7, elevation: -2 }],
  ...
  },
  {
    ...
    status: 'llm',
    category: 'videoGame',
    hypercastle: [{ level: 6, elevation: 2 }, { level: 6, elevation: -4 }],
  ...
  },
  {
    ...
    status: 'llm',
    category: 'cryptoArt',
    hypercastle: [{ level: 5, elevation: 2 }, { level: 5, elevation: -1 }, { level: 5, elevation: -4 }],
  ...
  },
  {
    ...
    status: 'llm',
    category: 'animeFilm',
    hypercastle: [{ level: 7, elevation: 4 }, { level: 7, elevation: -1 }],
  ...
  },
  {
    ...
    status: 'llm',
    category: 'cryptoArt',
    hypercastle: [{ level: 14, elevation: -1 }],
  ...
  },
  {
    ...
    status: 'llm',
    category: 'nature',
    hypercastle: [{ level: 15, elevation: 0 }],
  ...
  },
  {
    ...
    status: 'llm',
    category: 'animeFilm',
    hypercastle: [{ level: 11, elevation: 0 }],
  ...
  },
  {
    ...
    status: 'llm',
    category: 'videoGame',
    hypercastle: [{ level: 11, elevation: 1 }],
  ...
  },
  {
    ...
    status: 'llm',
    category: 'nature',
    hypercastle: [{ level: 16, elevation: 3 }, { level: 16, elevation: -4 }],
  ...
  },
  {
    ...
    status: 'llm',
    category: null,
    hypercastle: [{ level: 7, elevation: 2 }, { level: 7, elevation: -3 }],
  ...
  },
  {
    ...
    status: 'llm',
    category: 'animeFilm',
    hypercastle: [{ level: 5, elevation: 4 }, { level: 5, elevation: 1 }, { level: 5, elevation: -2 }],
  ...
  },
  {
    ...
    status: 'llm',
    category: 'nature',
    hypercastle: [{ level: 8, elevation: 0 }],
  ...
  // ─── UNKNOWN ─────────────────────────────────────────────────────────────
  { id: 'boss',   name: '[BOSS]',  status: 'unknown', category: null, palette: ['#f8f7ff', '#ee0000'], images: null, hypercastle: [{ level: 11, elevation: 2 }] },
  { id: 'home',   name: '[HOME]',  status: 'unknown', category: null, palette: ['#303030', '#fff5e6'], images: null, hypercastle: [{ level: 11, elevation: 4 }, { level: 11, elevation: -3 }] },
  { id: 'wen',         name: '[WEN]',         status: 'unknown', category: null, palette: ['#fffdf0', '#1e1c32'], images: null, hypercastle: [{ level: 11, elevation: -1 }] },
  { id: 'dynacrypts',   name: 'Dynacrypts',    status: 'unknown', category: null, palette: ['#f98284', '#feaae4', '#b0a9e4', '#accce4', '#b3e3da', '#b0eb93', '#fff7a0', '#ffc384', '#dea38b', '#28282e'], images: null, hypercastle: [{ level: 13, elevation: -1 }] },
  { id: 'pfpfpfpbbx80', name: 'Pfpfpfpbbx80', status: 'unknown', category: null, palette: ['#f772b5', '#435d5a', '#5a7b70', '#e83b3b', '#ccdf6d', '#aede6a', '#ffffff', '#e4dde7'], images: null, hypercastle: [{ level: 15, elevation: 1 }] },
  { id: 'valeria',      name: 'Valeria',       status: 'unknown', category: null, palette: ['#fe004f', '#04a15c', '#fd8901', '#2c2827'], images: null, hypercastle: [{ level: 13, elevation: -3 }] },
];
