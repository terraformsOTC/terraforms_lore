// 113isms — quotes and snippets from the Mathcastles co-founder (113).
// Sourced manually from Twitter spaces and podcast appearances.
//
...
export const sections = [
  ...
  {
    label: 'tf 4th birthday twitter spaces · 17 dec 2025',
    items: [
